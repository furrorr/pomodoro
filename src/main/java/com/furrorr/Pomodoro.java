...
public class Pomodoro {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        if (workMinutes > 0 && breakMinutes > 0 && count > 0) startingTheTimer(workMinutes, breakMinutes, count, sizePrint);
        else numberLessZero(workMinutes, breakMinutes);

        System.out.println("-------------Bye pomodoro!-------------");
    }

    private static void startingTheTimer(int workMinutes, int breakMinutes, int count, int sizePrint) throws InterruptedException {
